...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gray-100 p-12 space-y-12">
      ...
      <div>
        <p class="mb-3 text-sm font-medium text-gray-500 uppercase tracking-wide">
          State 1 · Not authenticated
        </p>
        <div class="relative h-64 bg-white rounded-[10px] border border-gray-200 shadow-sm">
          <div
            ...
            <div class="text-center p-4">
              <p class="text-base font-semibold text-gray-900 mb-2">Access Restricted</p>
              <p class="text-sm text-gray-600">
                To use this tool, please log in or register for a BioCommons Access account and add the SBP Workflow Execution bundle to your profile.
              </p>
        ...
        <div class="relative h-64 bg-white rounded-[10px] border border-gray-200 shadow-sm">
          <div
            ...
            <div class="text-center p-4">
              <p class="text-base font-semibold text-gray-900 mb-2">Access Restricted</p>
              <p class="text-sm text-gray-600">
                You currently do not have access to this tool; please go to your profile
                page to add the <strong>SBP Workflow Execution</strong> bundle.
              </p>
              <div class="mt-3 flex justify-center">
                <a
                  [href]="profileUrl"
