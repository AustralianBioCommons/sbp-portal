...
describe('Home', () => {
  ...
  describe('ngOnInit and query parameter handling', () => {
    ...
    it('should handle multiple query parameters with tab parameter', () => {
      queryParamsSubject.next({ tab: 'structure-prediction', search: 'test', filter: 'active' });
  ...
  describe('isActiveTab', () => {
    ...
    it('should handle all tab types correctly', () => {
      const tabIds = ['binder-design', 'structure-prediction', 'structure-search', 'tools'];
      ...
      tabIds.forEach(tabId => {
        ...
        tabIds.filter(id => id !== tabId).forEach(inactiveId => {
  ...
  describe('tabs data validation', () => {
    ...
    it('should have consistent tab structure with expected IDs', () => {
      const expectedIds = ['binder-design', 'structure-prediction', 'structure-search', 'tools'];
