  ...
  navItems: NavItem[] = [
    {
      ...
      children: [
        ...
        { label: 'Structure prediction', path: '/themes?tab=structure-prediction', requiresAuth: false },
        { label: 'Structure search', path: '/themes?tab=structure-search', requiresAuth: false }
      ]
    },
    {
      ...
      children: [
        { label: 'Single structure prediction', path: '/workflow/wf?=single-structure-prediction' },
        { label: 'Interaction screening', path: '/workflow/wf?=interaction-screening' }
      ]
    },
    {
      label: 'Tools',
