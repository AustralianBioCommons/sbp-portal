  ...
  template: `
    <div class="relative" (focusout)="handleFocusOut($event)">
      <button
        ...
        (click)="toggleMenu()"
        class="flex h-11 w-full items-center justify-between rounded-xl border bg-white px-3 text-left text-sm text-slate-900 shadow-sm transition-colors focus:outline-none focus:ring-1"
